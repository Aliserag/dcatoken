...
/// Initialize the DCAHandlerEVMV4 with dual capabilities
///
/// Following the official scaffold pattern:
...
transaction() {
    ...
    prepare(signer: auth(Storage, Capabilities) &Account) {
        ...
        log("")
        log("SUCCESS: DCAHandlerEVMV4 initialized with dual capabilities")
