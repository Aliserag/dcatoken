...
/// - Source token (e.g., FLOW) → Target token (e.g., Beaver)
...
/// - Uses IncrementFi connectors for swaps
///
/// Educational Notes:
...
access(all) contract DCAPlanV2 {
    ...
    access(all) resource Plan {
        ...
        /// Target token type identifier (e.g., A.687e1a7aef17b78b.Beaver.Vault)
        ...
        init(
            ...
            self.id = DCAPlanV2.nextPlanId
            DCAPlanV2.nextPlanId = DCAPlanV2.nextPlanId + 1
    ...
    init() {
        self.nextPlanId = 1
        self.PlanStoragePath = /storage/DCAPlan
        self.PlanPublicPath = /public/DCAPlan
    }
}
