...
/// DCAServiceEVM: EVM-Native DCA Service with Shared COA (TESTNET VERSION)
///
...
///
/// NOTE: This testnet version uses testnet DEX router addresses
///
access(all) contract DCAServiceEVM {
    ...
    init() {
        ...
        // Testnet UniswapV3 Router (SwapRouter02)
        self.routerAddress = EVM.addressFromString("0x2Db6468229F6fB1a77d248Dbb1c386760C257804")
